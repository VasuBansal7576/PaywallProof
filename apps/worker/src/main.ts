...
const control=createControlApp({
  ...
  stripeKey:process.env.STRIPE_SECRET_KEY,stripeAccountId:process.env.STRIPE_ACCOUNT_ID,runtimeUrl:'http://127.0.0.1:8790',model:process.env.TRUEFORGE_MODEL??'paywallproof-local/qwen3-4b-nothink',
});
