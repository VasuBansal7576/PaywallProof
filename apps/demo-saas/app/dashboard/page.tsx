...
export default function Dashboard() {
  ...
  return <div className="workspace">
    ...
    <main className="main-content"><header className="topbar"><span>Workspace <span className="breadcrumb">/ Overview</span></span><span className="environment">Test environment</span></header>
      ...
      {account && <>
        {account.executionMode === 'local_replay' && <div className="replay-notice" role="note">Local replay · Billing events are synthetic test fixtures. This is not a Polar sandbox verification.</div>}
