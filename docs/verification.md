...
- The AT29 report has SHA-256 `be91a885a2624829dcd77cbfc96ebd52f150e804dc030001d0e257a75913ca71`. The run used `local_replay` with Polar, HydraDB, LLM, and CRM credentials removed, so no provider was called. A post-run bridge check confirmed zero extra credits and no paid fallback. This establishes contract-v1 lifecycle portability only. It is not Polar delivery or repair evidence.
