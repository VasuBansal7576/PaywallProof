...
- The submission-hardening gate passes formatting, repository shape, delivery configuration, skill validation, TypeScript, ESLint, 1,810 tests, the production web build, and all ten live browser-contract groups.
